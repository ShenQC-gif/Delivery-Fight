...
class ViewController: UIViewController,AVAudioPlayerDelegate {
    ...
    @IBOutlet weak var conveyor1: UIImageView!
    @IBOutlet weak var conveyor2: UIImageView!
    @IBOutlet weak var conveyor3: UIImageView!
    @IBOutlet weak var conveyor4: UIImageView!
    @IBOutlet weak var conveyor5: UIImageView!

    @IBOutlet weak var pullbtn11: UIButton!
    @IBOutlet weak var pullbtn12: UIButton!
    @IBOutlet weak var pullbtn13: UIButton!
    @IBOutlet weak var pullbtn14: UIButton!
    @IBOutlet weak var pullbtn15: UIButton!
    
    @IBOutlet weak var pushbtn11: UIButton!
    @IBOutlet weak var pushbtn12: UIButton!
    @IBOutlet weak var pushbtn13: UIButton!
    @IBOutlet weak var pushbtn14: UIButton!
    @IBOutlet weak var pushbtn15: UIButton!
    
    @IBOutlet weak var pullbtn21: UIButton!
    @IBOutlet weak var pullbtn22: UIButton!
    @IBOutlet weak var pullbtn23: UIButton!
    @IBOutlet weak var pullbtn24: UIButton!
    @IBOutlet weak var pullbtn25: UIButton!
    
    @IBOutlet weak var pushbtn21: UIButton!
    @IBOutlet weak var pushbtn22: UIButton!
    @IBOutlet weak var pushbtn23: UIButton!
    @IBOutlet weak var pushbtn24: UIButton!
    @IBOutlet weak var pushbtn25: UIButton!
    ...
    @IBOutlet weak var winloselabel1: UILabel!
    @IBOutlet weak var winloselabel2: UILabel!
...
//        winloselabel2.frame = CGRect(x: width*3/28, y: height*28.5/32, width: width*6/28, height: height*3/32)
        ...
        self.view.addSubview(present2)
        self.view.addSubview(present3)
        self.view.addSubview(present4)
        self.view.addSubview(present5)
    ...
    func startgame(){
        ...
        timerlabel1.text = String(self.resttime)
        timerlabel2.text = String(self.resttime)
    ...
    func initailstate(){
        ...
        //各presentの位置を初期位置に
        present1.frame.origin.y = self.height*15/32
        present2.frame.origin.y = self.height*15/32
        present3.frame.origin.y = self.height*15/32
        present4.frame.origin.y = self.height*15/32
        present5.frame.origin.y = self.height*15/32
    ...
    //どちらの得点か判定
    func whosepresent(present : UIImageView, btnline:Array<UIButton>){
    ...
    //btnlineの有効化/無効化を管理
    func btnlinestatus(btnline:Array<UIButton>, status:Bool){
    ...
    @IBAction func makesoundbtn(_ sender: Any) {
